...
trait DeliteApplication extends DeliteOpsExp with ScalaCompile {
  ...
  lazy val targets = if (Config.useCuda) List[DeliteApplicationTarget](scalaTarget, cudaTarget /*, cTarget*/) 
    else List[DeliteApplicationTarget](scalaTarget /*, cudaTarget, cTarget*/) 
